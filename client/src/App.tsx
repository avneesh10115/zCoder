...
export const API_URL = "https://zcoder-b8dz.onrender.com";
        ...
        <div className="App">
            <BrowserRouter>
                <Routes>
                    ...
                    />
                    <Route
                        path="/problem/:name/discussion"
                        element={
                            <ProblemPage
                                data={{ activeNavOption: "discussion" }}
                                token={token}
                                id={id}
                            />
                        }
                    />
                    <Route
                        path="/problem/:name/discussions/:threadId"
                        element={<ThreadDetailPage token={token} id={id} />}
                    />
                    <Route
                    ...
                    <Route
                        path="/problem/:name/discussion"
                        element={<DiscussionPage token={token} id={id} />}
                    />
                    <Route
                        path="/problem/:name/discussion/:threadId"
                        element={<ThreadDetailPage token={token} id={id} />}
                    />
                    <Route
                        path="/login"
